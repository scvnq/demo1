...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__register__ = __webpack_require__(788);
...
var RegisterPage = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log(result);
                        this.eMessage = " ";
                        this.sMessage = "Account created, back to login!";
                        return [3 /*break*/, 3];
                    case 2:
                        e_1 = _a.sent();
                        console.error(e_1);
                        this.eMessage = e_1.message;
                        this.sMessage = " ";
                        return [3 /*break*/, 3];
    ...
    RegisterPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-register',template:/*ion-inline-start:"/Users/suannai/Downloads/lab5/src/pages/register/register.html"*/'<!--\n  Generated template for the RegisterPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Register</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-item>\n    <ion-label floating>Email Address</ion-label>\n    <ion-input type="text" [(ngModel)]="user.email"></ion-input>\n  </ion-item>\n\n  <ion-item>\n    <ion-label floating>Password</ion-label>\n    <ion-input type="password" [(ngModel)]="user.password"></ion-input>\n  </ion-item>\n  <label class="error">{{eMessage}}</label>\n  <label class="success">{{sMessage}}</label>\n  <button ion-button (click)="register(user)">Register with email</button><br>\n</ion-content>\n'/*ion-inline-end:"/Users/suannai/Downloads/lab5/src/pages/register/register.html"*/,
